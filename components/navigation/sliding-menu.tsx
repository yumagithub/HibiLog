...
const externalNavItems = [
  { path: "/camera", label: "投稿", icon: Upload },
...
export function SlidingMenu() {
  ...
  return (
    ...
    />
      ...
      >
        {/* --- 矢印の山（ハンドル） --- */}
        <div className="pointer-events-auto cursor-grab active:cursor-grabbing px-10 py-2"
        // ★ ダブルクリックイベントを追加
          ...
          <motion.div
            ...
            transition={
              isMenuOpen 
                ...
                : { y: { repeat: Infinity, duration: 2 }, rotate: { duration: 0.3 } } 
              }
                ...
                >
                  <motion.div 
                    ...
                    className={cn(
                      ...
                      isActive ? "bg-primary text-white shadow-lg" : "bg-muted/50 text-muted-foreground group-hover:bg-muted"
                    )}
                  >
